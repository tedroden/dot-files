...
;; -- Suggestion
;; Remove twit-region and have twit-post detect the region if set. Using thingatpt+,
;; region-or-word-at-point is convenient as the default e.g
;; (defun twit-query-for-post (prompt-heading initial-input) 
;;  "Query for a Twitter.com post text in the minibuffer."
;;  (read-string (concat prompt-heading " (140 char max): ") (if initial-input initial-input ;; (region-or-word-at-point))))
