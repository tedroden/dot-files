...
(defun ted-use-underline-p (&optional display)
...
(defvar ted-insignificant-face
  (if window-system
     '(:foreground "gray30")
   '()))

;; Ensuring `max-lisp-eval-depth' and `max-specpdl-size' are big enough
;; for the backquote in `color-theme-ted', as well as for running
...
`color-theme-ted' are often washed-out variants of the colors
...
speedbar, tex, view, viper, w3m, widget, woman"
  ...
  (color-theme-install
   `(color-theme-ted
     ...
     (dired-ignored ((t ,ted-insignificant-face)))
     (dired-face-boring ((t ,ted-insignificant-face)))
     (dired-face-permissions ((t ,ted-insignificant-face)))
     (dired-face-setuid ((t (:bold t :foreground "medium sea green"))))
     (dired-face-socket ((t ,ted-insignificant-face)))
 ...
 :bold t))))
     ...
     (erc-fool-face ((t ,ted-insignificant-face)))
     ...
     (escape-glyph ((t ,ted-insignificant-face)))
     ...
     (eshell-ls-product-face ((t ,ted-insignificant-face)))
     (eshell-ls-product ((t ,ted-insignificant-face)))
     (eshell-ls-readonly-face ((t ,ted-insignificant-face)))
     (eshell-ls-readonly ((t ,ted-insignificant-face)))
     ...
     (file-name-shadow ((t ,ted-insignificant-face)))
     ...
     (font-latex-sedate-face ((t ,ted-insignificant-face)))
     ...
     (gnus-header-content-face ((t ,ted-insignificant-face)))
     (gnus-header-content ((t ,ted-insignificant-face)))
     ...
     (gnus-signature-face ((t ,ted-insignificant-face)))
     (gnus-signature ((t ,ted-insignificant-face)))
     ...
     (js2-jsdoc-html-tag-delimiter-face ((t ,ted-insignificant-face)))
     ...
     (nxml-processing-instruction-delimiter ((t ,ted-insignificant-face)))
     (nxml-processing-instruction-target ((t (:foreground "steel blue"))))
     (nxml-processing-instruction-content ((t ())))
     (nxml-cdata-section-delimiter ((t ,ted-insignificant-face)))
     ...
     (nxml-tag-delimiter ((t ,ted-insignificant-face)))
     ...
     (nxml-markup-declaration-delimiter ((t ,ted-insignificant-face)))
     ;; (nxml-hash ((t ())))
     ;; (nxml-glyph ((t ())))
     ...
     (paren-face ((t ,ted-insignificant-face)))
     ...
     (rng-error ((t ,(if (ted-use-underline-p)
                         '(:underline "red")
     ...
     (shadow ((t ,ted-insignificant-face)))
     ...
     (slime-reader-conditional-face ((t ,ted-insignificant-face)))
     ...
     (widget-inactive-face ((t ,ted-insignificant-face)))
...
(provide 'color-theme-ted)

;;; color-theme-ted.el ends here
