...
;;-----------------------------------------------------------------------------
	...
	(top-toolbar-shadow-color . "#111111"))
       (default ((t (nil))))
       (button ((t (:bold t))))
       (fringe ((t (:background "#000000" :foreground "#444444"))))
...
;; Subdued text highlighting 2
     ...
     (speedbar-separator-face ((t (:inherit org-table :background "#555555" :height 0.9))))
...
;; Bright box highlight, you could try #555 instead of #777
       (isearch ((t (:background "#777777" :foreground "white"))))
...
;; Subdued box highlight 2
       ...
       (widget-field-face ((t (:inherit highline-face :foreground "#555555" ))))
       ...
       (tabbar-default-face ((t (:inherit variable-pitch :background "#222222" :height 0.8))))
